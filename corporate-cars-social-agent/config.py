...
# --- Opal Chauffeurs Meta & Social Credentials ---
OPAL_META_ACCESS_TOKEN = os.getenv("OPAL_META_ACCESS_TOKEN", "")
OPAL_META_PAGE_ID = os.getenv("OPAL_META_PAGE_ID", "102034409405004")
OPAL_INSTAGRAM_BUSINESS_ACCOUNT_ID = os.getenv("OPAL_INSTAGRAM_BUSINESS_ACCOUNT_ID", "17841456911741892")
OPAL_LINKEDIN_ORGANIZATION_URN = os.getenv("OPAL_LINKEDIN_ORGANIZATION_URN", "urn:li:organization:87379144")
