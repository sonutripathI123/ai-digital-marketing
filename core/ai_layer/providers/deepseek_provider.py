"""
DeepSeek Provider Adapter Interface.

Supports DeepSeek-V3 (`deepseek-chat`) and DeepSeek-R1 (`deepseek-reasoner`).
Reads DEEPSEEK_API_KEY securely from environment or runtime parameter.
"""
...
class DeepSeekProvider(BaseAIProvider):
    ...
    def generate(self, request: LLMRequest, model_override: Optional[str] = None) -> LLMResponse:
        ...
        model_name = model_override or request.preferred_model or "deepseek-chat"
        ...
        if not self._api_key:
            return LLMResponse(
                ...
                success=False,
                error_message="DEEPSEEK_API_KEY is not configured in environment. Please add it via the AI Vault.",
        ...
        try:
            ...
            with urllib.request.urlopen(req, timeout=30) as resp:
                ...
                pricing = TOKEN_PRICING.get(model_name, {"input": 0.00014, "output": 0.00028})
